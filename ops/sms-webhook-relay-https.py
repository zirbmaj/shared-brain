#!/usr/bin/env python3
"""
SMS Webhook Relay (HTTPS) — receives incoming SMS from SMSGate and posts to Discord.
Uses SMSGate CA certificate for private network HTTPS.
"""
...
CERT_DIR = os.path.expanduser("~/shared-brain/ops/sms-certs")
PORT = 3870
...
if __name__ == "__main__":
    ...
    # Set up HTTPS with SMSGate CA cert
    ...
    print(f"SMS webhook relay (HTTPS) listening on :{PORT}")
