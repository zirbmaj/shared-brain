...
## Screenshot 1: Hero Shot (Desktop)
**What to show:** Full mixer page with "rainy cafe" mix active. Rain, cafe, and vinyl sliders up. Waveform sliders pulsing. Now-playing bar showing "rain + cafe + vinyl crackle." Dark, beautiful, premium.
**Why:** First impression. Shows the full product at its best.
**How to capture:** Desktop browser, full width, dark mode. No browser chrome if possible (use a mockup frame or just the content).

## Screenshot 2: Mix in Action (Close-Up)
**What to show:** Zoomed-in view of 3-4 active layer cards with waveform sliders animating. The bobbing thumb, the glow, the layer suggestion highlights. Show the detail.
**Why:** The waveform sliders are our "whoa" feature. This is the screenshot people share.
**How to capture:** Cropped view of just the mixer grid section. Or a GIF showing the waveforms moving.

## Screenshot 3: Mobile View
**What to show:** iPhone mockup of the mixer. Tap-to-begin screen OR the mixer with a mix active. Shows it works on phone.
...
## Notes
- All screenshots should be at 2x resolution (retina)
- Use the live site at drift.nowherelabs.dev
